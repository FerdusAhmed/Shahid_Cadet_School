...
const FormField = ({ label, icon: IconComponent, id, type = "text", placeholder, isTextArea, validation, register, errors }) => (
  <div className="flex flex-col gap-1.5 group">
    ...
    <div className="relative">
      <IconComponent size={16} className={`absolute left-4 top-3.5 transition-colors ${errors[id] ? 'text-rose-400' : 'text-slate-400 group-focus-within:text-indigo-500'}`} />
      {isTextArea ? (
